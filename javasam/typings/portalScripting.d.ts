...
declare interface Context {
     ...
     * optional definition, if locked users also should be returned. The default value is `false`.
     * @param includeInvisibleUsers **Default:** `false`.
     * Optional flag indicating whether the method also should return users for which the option "Display user in DOCUMENTS lists" in the Documents Manager is not checkmarked. The default value is `false`.
     ...
     * Optional flag indicating whether only released workflows should be returned. The default value is `true`.
     ...
     * Optional boolean indicating whether the pem-file for the current principal to be reloaded. The default value is `false`.
     * @returns `true` if successful, `false` in case of any error.
     ...
     * @param pemReload **Default:** `false`.
     * Optional boolean indicating whether the pem-file for the desired principal to be reloaded. The default value is `false`.
     * @returns `true` if successful, `false` in case of any error.
...
declare interface CustomProperty {
     ...
     * Optional boolean indicating whether all subproperties should be also deleted recursively. The default value is `false`.
     * @returns `true` if successful, `false` in case of any error
     */
...
declare interface DocFile {
     ...
     * optional start tag. The default value is "%".
     * @param endTag **Default:** `"%"`.
     * otional end tag. The default value is "%".
     * @returns String containing the parsed value of the autotext
     * @example
     * var myFile = context.file;
     ...
     *
     * **Note:** The index `i` is zero-based. The specification of field instance is olny available for an EE.i/EE.x archive file, it will be ignored for other files. If the parameter contains no instance information, the first field instance is used. The field instance order is determined by the field order in the file.
     * @param returnType Optional string specified the type of the return value. Currently only the type "Array" is available for **a double select list field**.
...
declare class DocumentsRemoteJSON {
     ...
     *   reqJson.time = context.addTimeInterval(new Date(), 2, "days", false);
 ...
 *
 * The objects of this class represent lists of Email objects and allow to loop through such a list of emails. The following methods return an EmailIterator: Context.getMails().
 * @since DOCUMENTS 5.0i
 * @example
...
declare class File {
     ...
     * @param encoding optional, should be set to `"utf-8"` for DocumentsOS
     *
...
declare interface SystemUser {
     ...
     * @since DOCUMENTS 5.0a
     * @param notifying
     * boolean indicating whether new files in inbox are to be notified to the user. The default value is `true`.
     *
     * **Default:** `true`
     * @returns `true` if successful, `false` in case of any error.
     * @example
...
declare interface Util {
    ...
    /**
     * **Returns the OCR content of binary.**
     *
     * **Note:** OCR license is necessary
     *
     ...
     */
    readTextFileAsString(pathToTextFile: string): string;
    /**
     ...
     */
    writeStringToTextFile(pathToTextFile: string, content: string): boolean;
}
/**
...
declare class XMLExport {
     ...
     * Optional export conditions specified as follows: <ul> <li>boolean value indicating whether the file id should be exported as update key. </li> <li>XMLExportDescription object defining serveral conditions for the exporting process of the DocFile object. </li> </ul> The default value is true.
     * @returns `true` if successful, `false` in case of any error
     * @example
     ...
     * Optional String value defining the desired export format. The following formats are available: <ul> <li>5.0 (DOCUMENTS 5.0) </li> <li>6.0 (DOCUMENTS 6.0) </li> </ul> The default value is "6.0".
     * @returns `true` if successful, `false` in case of any error
     * @example
     ...
     * Optional boolean value indicating whether the XML output is able to update the same folder (Update-XML) in case of exporting the folder structure. The default value is false.
     *
...
declare class XMLHTTPRequest {
     ...
     * @returns
     * @example
     * var url = "https://documents.otris.de/";
     * var async = false;
     * var xmlHttp = new XMLHTTPRequest();
     * // Important: method-order:
     * // 1. open()
