declare namespace otris {
    ...
    namespace scriptlist {
        ...
        class List {
             ...
             * @param listAction.action Action to be executed, e.g.<br><br> * <strong>runScript:&lt;script-name&gt;[&amp;&lt;param1&gt;=&lt;value1&gt;&amp;&lt;param2&gt;...]</strong> - execute a portal script and pass parameters * <strong>showFile:&lt;fileId&gt;</strong> - show a file * <strong>showFolder:&lt;folderId&gt;</strong> - show a folder * <strong>showHomeView</strong> - show the home * <strong>executePrivateSearch</strong> - execute a private search * <strong>refreshScriptlist[&amp;&lt;param1&gt;=&lt;value1&gt;&amp;&lt;param2&gt;...]</strong> - Refresh the current scriptlist with passed parameters. * <strong>xlsxExportSelected</strong> - export selected entries as xlsx * <strong>xlsxExportAll</strong> - export all entries as xlsx
            ...
            /**
             * Add export actions to the scriptlist. If an export action is executed, the origin script will be called again with current search and sort parameters and a special scriptlist-event (xlsxExportAll or xlsxExportSelected), which will be handled in list.transfer(). The handling of this event will cause <strong>context.returnType</strong> to be set, so the download can start after the script has finished executing. After list.transfer() the context.returnType <strong>must not be changed</strong> or the download of the exported file will not work. Currently supports xlsx-export (since DOCUMENTS 5.0i HF5).
        ...
        class Grouping {
             ...
             * @param columnOrGroup.comparator {comparatorCB} Callback to sort values of this group.
...
declare interface addAction_listAction {
     ...
     * * <strong>executePrivateSearch</strong> - execute a private search
